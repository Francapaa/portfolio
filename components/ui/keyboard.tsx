...
const KeyboardProvider = ({
  ...
  }, [isVisible, playSoundDown, playSoundUp, setPressed, setReleased, onKeyPress]);
  ...
  return (
    <div className="h-full w-fit rounded-xl bg-neutral-200 p-1 shadow-sm ring-1 shadow-black/5 ring-black/5">
      ...
      <Row>
        ...
        <Key onKeyPress={onKeyPress} keyCode="F1">
          <IconBrightnessDown className="h-[6px] w-[6px]" />
          <span className="mt-1">F1</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F2">
          <IconBrightnessUp className="h-[6px] w-[6px]" />
          <span className="mt-1">F2</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F3">
          <IconTable className="h-[6px] w-[6px]" />
          <span className="mt-1">F3</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F4">
          <IconSearch className="h-[6px] w-[6px]" />
          <span className="mt-1">F4</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F5">
          <IconMicrophone className="h-[6px] w-[6px]" />
          <span className="mt-1">F5</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F6">
          <IconMoon className="h-[6px] w-[6px]" />
          <span className="mt-1">F6</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F7">
          <IconPlayerTrackPrev className="h-[6px] w-[6px]" />
          <span className="mt-1">F7</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F8">
          <IconPlayerSkipForward className="h-[6px] w-[6px]" />
          <span className="mt-1">F8</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F9">
          <IconPlayerTrackNext className="h-[6px] w-[6px]" />
          <span className="mt-1">F9</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F10">
          <IconVolume3 className="h-[6px] w-[6px]" />
          <span className="mt-1">F10</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F11">
          <IconVolume2 className="h-[6px] w-[6px]" />
          <span className="mt-1">F11</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="F12">
          <IconVolume className="h-[6px] w-[6px]" />
          <span className="mt-1">F12</span>
        </Key>
        <Key onKeyPress={onKeyPress} containerClassName="rounded-tr-xl" className="rounded-tr-lg">
      ...
      {/* Number Row */}
      <Row>
        <Key onKeyPress={onKeyPress} keyCode="Backquote">
          <span>~</span>
          <span>`</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit1">
          <span>!</span>
          <span>1</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit2">
          <span>@</span>
          <span>2</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit3">
          <span>#</span>
          <span>3</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit4">
          <span>$</span>
          <span>4</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit5">
          <span>%</span>
          <span>5</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit6">
          <span>^</span>
          <span>6</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit7">
          <span>&</span>
          <span>7</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit8">
          <span>*</span>
          <span>8</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit9">
          <span>(</span>
          <span>9</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Digit0">
          <span>)</span>
          <span>0</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Minus">
          <span>—</span>
          <span>_</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Equal">
          <span>+</span>
          <span>=</span>
        </Key>
        <Key onKeyPress={onKeyPress}
      ...
      <Row>
        ...
        {["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"].map((letter) => (
          <Key onKeyPress={onKeyPress} key={letter} keyCode={`Key${letter}`}>
            {letter}
          </Key>
        ))}
        <Key onKeyPress={onKeyPress} keyCode="BracketLeft">
          <span>{`{`}</span>
          <span>{`[`}</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="BracketRight">
          <span>{`}`}</span>
          <span>{`]`}</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Backslash">
          <span>{`|`}</span>
          <span>{`\\`}</span>
        </Key>
      </Row>
      ...
      <Row>
        ...
        <Key onKeyPress={onKeyPress} keyCode="Semicolon">
          <span>:</span>
          <span>;</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Quote">
          <span>{`"`}</span>
          <span>{`'`}</span>
        </Key>
        <Key onKeyPress={onKeyPress}
      ...
      <Row>
        ...
        <Key onKeyPress={onKeyPress} keyCode="Comma">
          <span>{`<`}</span>
          <span>,</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Period">
          <span>{`>`}</span>
          <span>.</span>
        </Key>
        <Key onKeyPress={onKeyPress} keyCode="Slash">
          <span>?</span>
          <span>/</span>
        </Key>
        <Key onKeyPress={onKeyPress}
      ...
      {/* Modifier Row */}
      <Row>
        <ModifierKey onKeyPress={onKeyPress}
          keyCode="Fn"
        ...
        <ModifierKey onKeyPress={onKeyPress} keyCode="ControlLeft">
          <IconChevronUp className="h-[6px] w-[6px]" />
          <span>control</span>
        </ModifierKey>
        <ModifierKey onKeyPress={onKeyPress} keyCode="AltLeft">
          <OptionKey className="h-[6px] w-[6px]" />
          <span>option</span>
        </ModifierKey>
        <ModifierKey onKeyPress={onKeyPress} keyCode="MetaLeft" className="w-8">
          <IconCommand className="h-[6px] w-[6px]" />
          <span>command</span>
        </ModifierKey>
        <Key onKeyPress={onKeyPress} keyCode="Space" className="w-[8.2rem]" />
        <ModifierKey onKeyPress={onKeyPress} keyCode="MetaRight" className="w-8">
          <IconCommand className="h-[6px] w-[6px]" />
          <span>command</span>
        </ModifierKey>
        <ModifierKey onKeyPress={onKeyPress} keyCode="AltRight">
          <OptionKey className="h-[6px] w-[6px]" />
          <span>option</span>
        </ModifierKey>
        {/* Arrow Keys */}
        <div className="flex h-6 w-[4.9rem] items-center justify-end rounded-[4px] p-[0.5px]">
          <Key onKeyPress={onKeyPress} keyCode="ArrowLeft" className="h-6 w-6">
            <IconCaretLeftFilled className="h-[6px] w-[6px]" />
          </Key>
          <div className="flex flex-col">
            <Key onKeyPress={onKeyPress} keyCode="ArrowUp" className="h-3 w-6">
              <IconCaretUpFilled className="h-[6px] w-[6px]" />
            </Key>
            <Key onKeyPress={onKeyPress} keyCode="ArrowDown" className="h-3 w-6">
