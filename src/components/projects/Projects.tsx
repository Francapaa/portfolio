      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {t.currentProjects.items.map((project) => (
              <div
                key={project.name}
              ...
              >
                ...
                <p
                  className="mb-4 leading-relaxed text-base font-medium"
                  style={{ color: "#0a1a2e", textShadow: "0 1px 4px rgba(255,255,255,0.5)" }}
                >
                  {project.description}
                </p>
                <ul className="space-y-1 mb-4">
                  {project.highlights.map((highlight, i) => (
                    <li
                      ...
                      style={{ color: "#0a1a2e", textShadow: "0 1px 3px rgba(255,255,255,0.5)" }}
                    >
